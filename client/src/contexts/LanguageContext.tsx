...
const translations: Record<Language, Record<string, string>> = {
  "zh-HK": {
    ...
    "ai.error": "生成失敗，請稍後再試。",
    "ai.copied": "已複製到剪貼板",
    // AI Modal — 多步驟表單補充 keys
    "ai.form.education": "最高學歷",
    "ai.education.associate": "副學士",
    "ai.education.bachelor": "學士",
    "ai.education.master": "碩士",
    "ai.education.doctorate": "博士",
    "ai.form.industry": "香港從事行業",
    "ai.form.industry.placeholder": "例如：金融、科技、零售、媒體",
    "ai.next": "下一步",
    "ai.form.identity": "身份",
    "ai.identity.founder": "創業者",
    "ai.identity.employee": "在職人士",
    "ai.form.companyName": "公司名稱",
    "ai.form.companyName.placeholder": "請輸入公司名稱（如有）",
    "ai.form.targetCompany": "目標公司",
    "ai.form.targetCompany.placeholder": "請輸入目標公司名稱",
    "ai.form.motivation": "申請動機",
    "ai.form.motivation.placeholder": "描述你想申請嘅原因同期望",
    "ai.form.goals": "申請目標",
    "ai.goals.subsidy": "前海補貼",
    "ai.goals.opc": "OPC 入駐",
    "ai.goals.both": "兩者都要",
    "ai.form.email": "電郵",
    "ai.form.optional": "可選",
    "ai.form.email.placeholder": "example@email.com",
    "ai.back": "返回",
  ...
  "zh-CN": {
    ...
    "ai.education.associate": "副学士",
    "ai.education.bachelor": "学士",
    "ai.education.master": "硕士",
    "ai.education.doctorate": "博士",
    ...
    "ai.identity.employee": "在职人士",
    "ai.form.companyName": "公司名称",
    "ai.form.companyName.placeholder": "请输入公司名称（如有）",
    "ai.form.targetCompany": "目标公司",
    "ai.form.targetCompany.placeholder": "请输入目标公司名称",
    "ai.form.motivation": "申请动机",
    "ai.form.motivation.placeholder": "描述你想申请的原因和期望",
    "ai.form.goals": "申请目标",
    "ai.goals.subsidy": "前海补贴",
    "ai.goals.opc": "OPC 入驻",
    "ai.goals.both": "两者都要",
    "ai.form.email": "电邮",
    "ai.form.optional": "可选",
